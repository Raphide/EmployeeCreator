  ...
  return (
    <div>
      ...
      <div className={styles.pic}>
        ...
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Asperiores, quibusdam aut laborum error nihil exercitationem voluptatibus! Dolore, fuga praesentium! Autem saepe aliquid soluta necessitatibus alias adipisci explicabo maiores voluptate sequi?</p>
        <NavLink to="/data">$$MONEY$$</NavLink></div>
      </div>
